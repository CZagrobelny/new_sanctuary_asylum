class Activity < ActiveRecord::Base
  ...
  def self.upcoming_two_weeks
    activities = [ Activity.for_week(beginning_of_week: Date.today.beginning_of_week, end_of_week: Date.today.end_of_week, order: 'asc', events: ['check_in', 'master_calendar_hearing', 'individual_hearing']) ]
    activities << Activity.for_week(beginning_of_week: 1.weeks.from_now.beginning_of_week, end_of_week: 1.weeks.from_now.end_of_week, order: 'asc',  events: ['check_in', 'master_calendar_hearing', 'individual_hearing'])
    activities
  end
