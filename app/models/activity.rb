class Activity < ApplicationRecord
  ACCOMPANIMENT_ELIGIBLE_EVENTS = ['master_calendar_hearing', 'individual_hearing', 'special_accompaniment', 'check_in', 'high_risk_ice_check_in', 'family_court', 'bond_hearing', 'fingerprinting']
