class User < ActiveRecord::Base
  devise :invitable, :database_authenticatable, :recoverable, :rememberable, :trackable, :secure_validatable, :session_limitable, :password_expirable, :password_archivable, :invite_for => 1.week
