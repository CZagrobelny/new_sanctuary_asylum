...
ActiveRecord::Base.transaction do
  ...
  #EOIR Caller User
  User.create!(first_name: 'NYC EOIR', last_name: 'Caller', email: 'nyc_eoir_caller@example.com', community_id: nyc_community.id, phone: '888 888 8888', password: 'Password1234', password_confirmation: 'Password1234', invitation_accepted_at: Time.now, role: 4, pledge_signed: true)
